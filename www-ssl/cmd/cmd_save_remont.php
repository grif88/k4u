...
mysql_query("UPDATE `d_cl_remont` SET `date`='$php_date',`admin`='$php_user',`admin_ip`='$php_user_ip',`reason`='$reason',`date_add`='$date_add',`date_finish`='$date_finish',`id_people`='$id_people',`comment`='$comment' WHERE `id`='$id_remont'");
