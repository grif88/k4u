...
print "<div class=\"div_h2\" onclick=\"javascript:location.replace('/admin/');\"></div>
<table class=\"main_t1\" cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" height=\"100%\" border=\"3\">
<tr vlign=\"middle\">
<td width=\"200\" height=\"150\"><a href=\"/\"><img src=\"img2/logo.jpg\" border=\"0\"></a></td>
<td height=\"150\">
<table cellspacing=\"0\" cellpadding=\"0\" width=\"100%\" height=\"100%\" border=\"0\"><tr align=\"center\" valign=\"middle\">
<td><span class=\"head3\">Интернет&nbsp;&nbsp;@</span><span class=\"head1\">&nbsp;k4u.Net&nbsp;</span><span class=\"head3\">@&nbsp;&nbsp;Провайдер</span><br><br>
<span class=\"head2\">Высокоскоростной безлимитный интернет для Вас.<br>Быстро. Надежно. Доступно.</span></td>\n";

// holiday
$res41=mysql_query("SELECT `id`,`title`,`img`,`source`,`count` FROM `d_holiday` WHERE `day`='$day' AND `month`='$month'");
...
if ( $num_r_res41 == 1 ) {
 if ( $_SESSION['anim'] == 1 ) {
  while ( $tmp41=mysql_fetch_assoc($res41) ) {
   ...
   $h_count=$tmp41["count"];
   print "<td width=\"200\" align=\"right\"><a href=\"$h_source\" target=\"_blank\"><img onclick=\"javascript:loadScript('js/counter.php?id=$h_id');\" height=\"150\" src=\"$h_img\" border=\"0\" title=\"$h_title ($h_count)\" /></a></td>\n";
  }
 } else {
  print "<td width=\"200\" id=\"anim_td\" align=\"right\"></td>\n";
 }
}
...
print "
<!-- div22 -->
<div id=\"div22\" style=\"position:fixed; left:0px; top:0px;\"><a href=\"$h_source\" target=\"_blank\"><img id=\"img22\" onclick=\"javascript:loadScript('js/counter.php?id=$h_id');\" height=\"400\" src=\"$h_img\" border=\"0\" title=\"$h_title ($h_count)\" /></a></div>
...
function clock_repeat() {
 ...
 if ( left_div < wid_temp ) {
  ...
  anim_td.innerHTML = '<a href=\"$h_source\" target=\"_blank\"><img onclick=\"javascript:count22();\" height=\"150\" src=\"$h_img\" border=\"0\" title=\"$h_title ($h_count)\" /></a>';
